...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Welcome To The Ebad Ali company</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Strong Your Future</span><br>
    <span class="w3-large">Strong Your Future</span>
...
<div class="w3-container" style="padding:128px 16px" id="about">
  ...
  <p class="w3-center w3-large">Ebad company</p>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      <h3>Some picture design by Ebad Ali</h3>
...
<div class="w3-container" style="padding:128px 16px" id="team">
  ...
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="w3images/affan.jpg" alt="Jane" style="width:100%">
        <div class="w3-container">
          <h3>Affan Ali</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="w3images/talha.jpg" alt="Mike" style="width:100%">
        <div class="w3-container">
          <h3>Talha Khan</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="w3images/taha.jpg" alt="Dan" style="width:100%">
        <div class="w3-container">
          <h3>Taha Ali</h3>
...
<div class="w3-container" style="padding:128px 16px" id="work">
  <h3 class="w3-center">Ebad Ali WORK</h3>
...
<!-- FORM -->
    ...
    <!-- <from method="post" action="/insert_data.php" target="_blank">
       -->
       <form action="/ebad/insert_data.php" method="post" target="_blank">
